    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            do
            {
                ...
                if (readResult != null)
                {
                    ...
                    do
                    {
                        Console.WriteLine("Enter a physical description of the pet (size, color, gender, wight, housebroken)");
                        readResult = Console.ReadLine();
                        if (readResult != null)
                        {
        ...
        case "3":
            ...
            for (int i = 0; i < petCount; i++)
            {
                ...
                } while (validEntry == false || readResult == "");
